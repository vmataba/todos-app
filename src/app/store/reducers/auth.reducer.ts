...
import {login, loginFail, loginSuccess, logout, signup, signupFail, signupSuccess} from "../actions/auth.action";
...
export const authReducer = createReducer(initialState,
  ...
  on(loginSuccess, (state, {user}) => ({...state, loading: false, loaded: true, user, isGuest: false})),
